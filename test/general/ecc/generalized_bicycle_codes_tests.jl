@testset "ECC GB" begin
    ...
    @testset "Codes from Appendix B of [koukoulekidis2024smallquantumcodesalgebraic](@cite))" begin
        ...
        for m in 2:10
            R, x = polynomial_ring(GF(2), :x)
            ext_code = ExtendedGeneralizedBicycle(c, m, one(R))
