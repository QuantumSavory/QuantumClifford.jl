@testitem "ECC ZSZ" tags=[:ecc, :ecc_bespoke_checks, :oscar_required] begin
    ...
    # All 13 codes from Table 1 of Guo et al
    ...
    @testset "Full parity checks for small codes" begin
        # Codes with n <= 288: full parity check, rank, and weight verification
        small_codes = [
            ("ZSZ80",    5,  8,  2,  [(0,0), (4,4), (4,1)],   [(0,0), (3,0), (2,7)],   2),
            ("ZSZ108",   3,  18, 2,  [(0,0), (1,0), (0,3)],   [(0,0), (1,1), (2,12)],  2),
            ("ZSZ144-3", 12, 6,  5,  [(0,1), (2,2), (8,3)],   [(4,0), (6,4), (1,5)],   12),
        ...
        for (name, l, m, q, A, B, expected_k) in small_codes
            c = ZSZ(l, m, q, A, B)
            expected_n = 2 * l * m
    ...
    # Codes with n >= 360 are disabled for full parity check tests: Oscar group algebra construction scales with |G|^2 and exceeds CI time limits. Verified locally.
    #=
    @testset "Heavy codes" begin
        heavy_codes = [
            ("ZSZ360-1", 30, 6,  19, [(0,0), (8,2), (26,4)],  [(0,0), (21,4), (5,5)],  16),
            ("ZSZ360-2", 30, 6,  19, [(0,0), (9,1), (26,4)],  [(0,0), (4,5), (16,3)],  20),
            ("ZSZ360-3", 30, 6,  11, [(12,1), (21,4), (4,5)], [(4,3), (20,3), (22,4)], 12),
