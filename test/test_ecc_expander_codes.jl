@testitem "ECC Quantum Expander codes" begin
    ...
    using QuantumClifford.ECC: parity_checks_xz, product_tanner_graph_X, product_tanner_graph_Z, tanner_graph_from_parity_matrix, product_parity_matrix_from_tanner_graph, parity_matrix_from_tanner_graph, generate_random_bipartite_graph
    ...
    @testset "Fully connected bipartite graph" begin
        ...
        H = QuantumClifford.ECC.parity_matrix_from_tanner_graph(bg.graph, bg.left, bg.right)
