@testitem "ECC 2BGA" begin
    ...
    @testset "Reproduce Table 2 lin2024quantum" begin
        ...
        # [[16, 2, 4]] 2BGA code
        @test distance(c; solver=HiGHS) == 4
        ...
        c = two_block_group_algebra_codes(A,B)
        # [[16, 8, 2]] 2BGA code
        @test distance(c; solver=HiGHS) == 2
        ...
        c = two_block_group_algebra_codes(A,B)
        # [[24, 4, 5]] 2BGA code
        @test distance(c; solver=HiGHS) == 5
        ...
        c = two_block_group_algebra_codes(A,B)
        # [[40, 4, 8]] 2BGA code
        @test distance(c; solver=HiGHS) == 8
        ...
        c = two_block_group_algebra_codes(A,B)
        # [[48, 8, 6]] 2BGA code
        @test distance(c; solver=HiGHS) == 6
        ...
        c = two_block_group_algebra_codes(A,B)
        # [[48, 16, 3]] 2BGA code
        @test distance(c; solver=HiGHS) == 3
        ...
        c = two_block_group_algebra_codes(A,B)
        # [[56, 8, 7]] 2BGA code
        @test distance(c; solver=HiGHS) == 7
