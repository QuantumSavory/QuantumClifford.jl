@testitem "ECC Multivaraite Bicycle" tags=[:ecc, :ecc_bespoke_checks] begin
    ...
    using QuantumClifford.ECC: code_k, code_n, two_block_group_algebra_codes, distance, DistanceMIPAlgorithm
    ...
    @testset "Hecke Small Groups for single cyclic groups" begin
        ...
        @test distance(c, DistanceMIPAlgorithm(solver=HiGHS, time_limit=900)) == 9
        ...
        @test distance(c, DistanceMIPAlgorithm(solver=HiGHS, time_limit=900)) == 10
