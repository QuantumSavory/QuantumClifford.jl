...
struct RandomCircuitCode <: AbstractECC
    arrange::NTuple{N,Int} where {N} # the spatial arrangement of qubits
    connect::Union{Val{:alltoall},Val{:brickwork}} # the gate connectivity
    circ::Vector{QuantumClifford.AbstractOperation} # the random generated encoding circuit
    encode_qubits::AbstractArray # the qubits to be encoded
    # TODO it will be nicer if we can use CartesianIndex for encode_qubits here,
