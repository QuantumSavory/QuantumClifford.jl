"""This class implements the family of Gottesman codes [[2^j, 2^j - j - 2, 3]], also known as quantum Hamming codes, as described in Gottesman's 1997 thesis on stabilizer codes [Gottesman1997](@cite).
...
Notes:
- This implementation adopts the Gottesman Notation for the [[8, 3, 3]] stabilizer as depicted in Table 3.3 on Page 22 on the Gottesman's thesis. Additionally, for j = 4, our [[16, 10, 3]] stabilizer stemming from QHamming(4) can be cross-verified from Table 8.1 on Page 91 as well [Gottesman1997](@cite).
- The differences between [6506105](@cite), [Chao2017QuantumEC](@cite), and [Gottesman1997](@cite) primarily lie in the choice of stabilizer generators and their permutations.
