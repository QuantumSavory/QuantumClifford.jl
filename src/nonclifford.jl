...
julia> nc = 2; nc = embed(2, 2, pcT); for i in 1:3 apply!(sm, nc) end;
...
+ ZZ
with ϕᵢⱼ | Pᵢ | Pⱼ:
 0.146447+0.0im | + __ | + __
 0.0+0.353553im | + __ | + Z_
 0.0-0.353553im | + Z_ | + __
 0.853553+0.0im | + Z_ | + Z_
...
+ __ZZ
with ϕᵢⱼ | Pᵢ | Pⱼ:
 0.0-0.0517767im | + Z___ | + ____
 -0.125+0.0im | + Z_Z_ | + ____
 0.125+0.0im | + Z___ | + Z___
 0.0214466+0.0im | + ____ | + ____
 0.0-0.301777im | + Z_Z_ | + Z___
 0.0-0.0517767im | + __Z_ | + ____
 0.0+0.0517767im | + ____ | + Z___
 0.125+0.0im | + __Z_ | + Z___
 0.125+0.0im | + Z___ | + __Z_
 0.0-0.301777im | + Z_Z_ | + __Z_
 0.0+0.301777im | + Z___ | + Z_Z_
 0.0+0.0517767im | + ____ | + __Z_
 0.728553+0.0im | + Z_Z_ | + Z_Z_
 0.125+0.0im | + __Z_ | + __Z_
 -0.125+0.0im | + ____ | + Z_Z_
 0.0+0.301777im | + __Z_ | + Z_Z_
