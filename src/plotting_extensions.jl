...
# Quantikz in QuantumCliffordQuantikzExt

# Plots in QuantumCliffordPlotsExt
...
Alternatively, you can use the Plots.jl plotting ecosystem, e.g.
`using Plots; plot(S"XXX ZZZ")`.
