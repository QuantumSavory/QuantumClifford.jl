...
SUITE["pauliframe"]["pauliframesim"]["10^6_100"] = @benchmarkable QuantumClifford.pauliFrameCircuitHandler(10^6+1,circuit,ref_m,100) setup=(circuit = copy(x_diag_circuit(10^6)))
...
SUITE["pauliframe"]["quantumclifford"]["10000"] = @benchmarkable mctrajectory!(state, circuit)  setup=(state= Register(one(Stabilizer, 10001), [false]); circuit = copy(x_diag_circuit(10000)))
