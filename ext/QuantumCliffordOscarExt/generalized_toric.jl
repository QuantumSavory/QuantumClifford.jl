...
following approach mentioned in Appendix B of [liang2025generalizedtoriccodestwisted](@cite). Qubits
are indexed row-by-row: for each `y`-coordinate, horizontal edges are listed first,then vertical edges.
