...
- Added `detector_error_model` and `write_detector_error_model` to the ECC module,
  enabling export of code-capacity Stim `.dem` files from any code supporting
  `parity_checks` and `faults_matrix`. [#755]
